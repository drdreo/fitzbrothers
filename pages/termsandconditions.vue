      ...
      <div class="columns">
        <div class="column">
          ...
          <p>
            ...
            used to improve our services and to expedite your access to the
            website.
          </p>
          <p>
          ...
          <p>
            ...
            information entered when signing up, as shown in the registration
            form
          </p>
          <p><strong>Sign up: emailadress</strong></p>
          <p>
            is collected and stored solely for use by our website. When signing
            up for our website, we also store your IP address and the date and
            time you registered. This serves to protect us in the event a third
            party improperly and without your knowledge makes use of your data
            to sign up for our site.&nbsp;None of this information is
          ...
          <p>
            Our website uses Google Analytics, a web analysis service from
          ...
          <p>
            ...
            services related to website-&nbsp;and internet usage. Google may
            also transfer this information to third parties if this is required
            by law or to the extent this data is processed by third
          ...
          <p>
            Our website employs components provided by facebook.com. Facebook is
            a service of Facebook Inc., 1601 S. California Ave, Palo Alto, CA
            94304, USA.
          </p>
          <p>
            Each time our website receives an access request equipped with a
            Facebook component, the component prompts your browser to download
            an image of this Facebook component. Through this process, Facebook
            is informed precisely which page of our website is being
            visited.&nbsp;
          </p>
          <p>
            ...
            account on Facebook. Whenever you click on the&nbsp;“SignUp“ button,
            for example, this information is transmitted to your personal
            account on Facebook and stored there. In addition, Facebook is
            informed of your visit to our website. This occurs regardless of
            whether you click on a component or not.
          </p>
          <p>
            If you wish to prevent the transfer to and storage of data by
            Facebook about you and your interaction with our website, you must
            first log out of Facebook before visiting our website. The data
            protection policies of Facebook provide additional information, in
            particular about the collection and use of data by Facebook, your
            rights in this regard as well as the options available to you for
          ...
          <p>
            In addition, tools are freely available on the market that can be
            used to block Facebook social plug-ins with add-ons from being added
            to all commonly used browsers:
            <a
          ...
          <div>
            <h4 class="title is-4" style="position: relative;top:20px;">
              Disclaimer
            </h4>
            ...
            <p>
              ...
              furthermore responsible for our own content on this website. In
            ...
            <p>
              We intended not to use any copyrighted material for the
              publication or, if not possible, to indicate the copyright of the
              respective object. The copyright for any material created by us is
              reserved. Any duplication or use of objects such as images,
            ...
            <p>
              ...
              content or validity of the other parts remain uninfluenced by this
              fact.
            </p>
            <h4 class="title is-4" style="padding-top:20px;">
              Indication of source for images and graphics
            </h4>
            <p>
              Images:
              <a href="http://www.kevin-v.com" target="_blank"
                >Kevin Vandenberghe</a
              >,
              <a href="http://wwww.janfrankl.com/" target="_blank">Jan Frankl</a
              >,
              <a
          ...
          <p>
            Website by
            <a href="//andreas-hahn.at" target="_blank">Andreas K. Hahn</a>,
        ...
        <div class="column is-6 is-offset-1 is-hidden" id="form">
          ...
          <form @submit="checkForm">
            <div v-if="errors.length">
              ...
              <ul>
                <li class="help is-danger" v-for="error in errors">
                  {{ error }}
                </li>
              </ul>
            </div>
